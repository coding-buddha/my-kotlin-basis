...
class LibraryController(
    ...
    @PostMapping
    fun create(@RequestBody libraryCreateResources: LibraryCreateResources) : ResponseEntity<Library> {
        val library = libraryRepository.save(Library.from(libraryCreateResources))
